...
function showQuote() {
  ...
  newText.textContent = randomQuote.quote;
  newAuthor.textContent = "- " + randomQuote.author;

  clearAll();

  Quote.appendChild(newText);
  Quote.appendChild(newAuthor);
}
...
function showRiddle() {
  ...
  Riddle.appendChild(newRiddleText);
  Riddle.appendChild(newRiddleAnswer);
}
